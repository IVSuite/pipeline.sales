...
export function DealCard({ deal }: { deal: DealWithRelations }) {
  ...
  return (
    <div
      ...
      className={`cursor-grab space-y-2 rounded-lg border border-border bg-surface p-3 text-sm shadow-sm transition-shadow hover:shadow-md active:cursor-grabbing ${
